...
import {
  CategoryFilterTabs,
  LearnCategory,
} from "../../../components/learn/CategoryFilterTabs";
import {
  FeaturedArticleCard,
  ArticleListItem,
} from "../../../components/learn/ArticleCards";
import { educationService, notificationService } from "../../../services/api";
import {
  FireEducationArticle,
  Notification,
...
const FALLBACK_ARTICLES: FireEducationArticle[] = [
  {
    ...
    category: "prevention",
    summary:
      "Essential fire prevention practices for Filipino households during the dry season.",
  ...
  },
  {
    ...
    category: "prevention",
    summary:
      "Most house fires start in the kitchen. Learn how to prevent cooking fires.",
  ...
  },
  {
    ...
    category: "prevention",
    summary:
      "Overloaded circuits and faulty wiring are leading causes of residential fires.",
  ...
  },
  {
    ...
    category: "awareness",
    summary:
      "How FireSight calculates Low, Moderate, and High risk levels for your barangay.",
...
export default function LearnScreen() {
  ...
  const filtered = useMemo(
    () =>
      articles.filter(
        (a) =>
          a.content_id !== featured?.content_id &&
